...
2. **أجر الطلبيات يُقرأ بتمريرة واحدة بلا تصويت** — والمحفظة تُقرأ بثلاث تمريرات وتُنشر بتوافق
   اثنتين، أُضيف بعد خطأ `٢٧٩٫٥٠ → ٣٧٩٫٥٠`: **نفس التباس ٢/٣ بالضبط**. ووقت الطلبية يحتاج
   تمريرتين متّفقتين. المبلغ — أهمّ رقم في النظام — هو الحقل الوحيد بلا تصويت، وهو الذي فشل.
