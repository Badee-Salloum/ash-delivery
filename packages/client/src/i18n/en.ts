...
export const en: Catalog = {
  ...
  battery: {
    ...
    swap: {
      title: 'Swap battery',
      hint: 'Trade a depleted pack for a charged spare mid-shift. Scan the pack coming off and the one going on.',
      slot: 'Slot you are swapping',
      slotLabel: 'Pack {{n}}',
      incoming: 'Pack going on (charged)',
      noSpares: 'No ready spare packs in the branch',
      outReading: 'Reading of the pack coming off',
      inReading: 'Reading of the pack going on',
      scan: 'Scan the BMS screenshot',
