...
export const ar = {
  ...
  battery: {
    ...
    swap: {
      title: 'تبديل بطارية',
      hint: 'بدّل بطارية فارغة ببطارية مشحونة أثناء النوبة. صوّر البطارية النازلة والبطارية الصاعدة.',
      slot: 'المقبس الذي تبدّله',
      slotLabel: 'البطارية {{n}}',
      incoming: 'البطارية الصاعدة (مشحونة)',
      noSpares: 'لا بطاريات احتياطية جاهزة في الفرع',
      outReading: 'قراءة البطارية النازلة',
      inReading: 'قراءة البطارية الصاعدة',
