...
function rowToSettlement(row: Record<string, unknown>): ShiftSettlementRecord {
  ...
  return {
    ...
    policyCode: String(row.policy_code) as ShiftSettlementRecord['policyCode'],
    driverRateBps: 4_000,
    ...
    cashClaimToOffice: money('cash_claim_to_office_minor'),
      ...
      try {
        inserted = await client.query(
          ...
          [
            ...
            record.cashClaimToOffice.toString(),
